...
@section('subtitle','Registrate, Sofware Control de Consultas')
          ...
          <div class="card bg-secondary shadow border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <div class="alert alert-danger" role="alert">
                <strong> Upps!! A Ocurrido un error {{$errors->first()}}</strong> <img src="https://images.vexels.com/media/users/3/134551/isolated/preview/1fb74455a668b00b9ec2ab7d3092008b-emoticon-emoji-triste-by-vexels.png" alt="" width="30px" height="35px">
              </div>
            @else
